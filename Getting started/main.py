...
def main():
    ...
    llm = ChatOpenAI(
        temperature=0,
        model_name="GLM-5.1-Qwen3-1.7B-CoNDeNse-Q5_K_M.gguf",
        openai_api_base="http://127.0.0.1:1337/v1",
        openai_api_key="yes",
    )

    information = """  Here it is cleaned:
